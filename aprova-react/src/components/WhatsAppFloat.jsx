    ...
    <div className="whatsapp-float">
      {tooltip && (
        <div className="wa-tooltip">
          ...
          <button className="wa-tooltip-close" onClick={(e) => { e.stopPropagation(); setTooltip(false) }}>
            &times;
          </button>
        </div>
      )}
      <button className="wa-float-btn" onClick={openWhatsApp} aria-label="Contactar por WhatsApp">
